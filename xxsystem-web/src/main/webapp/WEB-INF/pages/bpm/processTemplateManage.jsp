...
var grid=Ext.create('Ext.grid.Panel', {
     ...
     columns: {
      items: [
       ...
       {header:'流程模版名称',dataIndex:'name',sortable:false,menuDisabled:true},
	   {header:'流程模版KEY值',dataIndex:'processDefineKey',sortable:false,menuDisabled:true},
	   {header:'流程模版种类名称',dataIndex:'categoryName',sortable:false,menuDisabled:true} 
     ]
    }
});
