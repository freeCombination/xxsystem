...
<script type="text/javascript"
	src="${ctx}/scripts/extjs/SpecialCharFilter.js"></script>
   ...
   createUserPanel:function(){
	...
	var userGrid =  Ext.create("Ext.grid.Panel",{
      ...
      moveTask:function(taskId,assignee){
		...
		dealshow:function dealshow(selectRows)
				{
		...
		bbar: {
     	...
     	columns: {
	        items: [
	            ...
	            {header:'事项名称',dataIndex:'processName',sortable:false,menuDisabled:true,width:100,draggable:false,
