	 ...
	 Ext.Ajax.request({ 
	        ...
	        success : function(response ,options) {
	    		    ...
	    		    if(result.data==null){
	    		    	...
	    		    	Ext.getCmp("noPassBtn").setDisabled(false);
	    		    	Ext.getCmp("rejectBtn").setDisabled(false);
	    		    	Ext.getCmp("passBtn").btnEl.dom.onclick=function(){
	    		    		if(!formFlow.getForm().isValid()){
	    						return;
	    					}
	    					 formFlow.getForm().findField("pass").setValue("true");
	    					 formFlow.getForm().findField("opinion").setValue(Ext.getCmp("initOpinion").getValue()+",审批结果为：同意");
	    		    	...
	    		    	Ext.getCmp("noPassBtn").btnEl.dom.onclick=function(){
	    		    		if(!formFlow.getForm().isValid()){
	    						return;
	    					}
	    					 formFlow.getForm().findField("pass").setValue("false");
	    					 formFlow.getForm().findField("opinion").setValue(Ext.getCmp("initOpinion").getValue()+",审批结果为：不同意");
	    					 formFlow.getForm().submit({
	    		                url:'${ctx}/bpm/compeleteTask.do',
	    		                waitTitle:"请等待...",
	    		        		waitMsg:"正在提交...",
	    		                success:function(form,action){
	    		              	...
	    		              	failure:function(form,action){
	    		              	Ext.Msg.alert(SystemConstant.alertTitle,"提交任务失败!");
	    		              	}
	    		            }); 
	    		    	};
	    		    	Ext.getCmp("rejectBtn").btnEl.dom.onclick=function(){
	    					if(!formFlow.getForm().isValid()){
								return;
				               }
								formFlow.getForm().findField("opinion").setValue(Ext.getCmp("initOpinion").getValue()+",审批结果为：退回");	
								formFlow.getForm().submit({
